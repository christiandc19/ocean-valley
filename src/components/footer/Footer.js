        ...
        <div className='footer'>
            <div className="container">
                <div className="top">
                    ...
                    <img src={logo} width="200px" height="60px" alt="Ocean Valley Rehab Logo" loading="lazy"/>
                    </div>
                ...
                <div className="col-container">
                    ...
                    <div className="col">
                        ...
                        <LinkRoll activeClass="active" to="top" spy={true} smooth={true} duration={500} >
                        <Link to='/tretment'><p>Programs</p></Link>
                        </LinkRoll>

                        <LinkRoll activeClass="active" to="top" spy={true} smooth={true} duration={500} >
                        <Link to='/jobs'><p>Job Assistance</p></Link>
                        </LinkRoll>
                    </div>
                ...
                <p className='copyright'><p>&copy; 2023  Ocean Valley Rehab Treatment Center. All rights reserved</p></p>
