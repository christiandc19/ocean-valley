            ...
            <div className='depression-section container'>
              <div className='depression-section-content'>
                ...
                <div className='depression-section-header'>
                  ...
                  Depression can occur in people from all walks of life, including those that suffer from Bipolar Disorder, and during or after pregnancy for females.<br/>It is much more than just feeling sad or having a bad day. Everyone experiences that.<br/>According to the CDC.gov, 1 in 6 adults experience depression, but it can happen to any age and any person. Many people with depression also suffer from other medical issues.</p>
                </div>

                <div className='depression-section-flex'>

                  <div className='depression-section-left'>
                    <p>Ranked as the third cause of Major depressive disorder (MDD) is the most severe form of depression. The most severe cases of MDD can result in suicide.<br/>There is clinical depression, and then there is Major Depressive Disorder.<br/>Symptoms of Major Depressive Disorder include:<br/>
                    <ul>
