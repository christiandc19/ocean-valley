...
const MdmaSection = () => {
  return (
    <>
            ...
            <div className='mdma-section container'>
              <div className='mdma-section-content'>
                <div className='mdma-section-flex'>
                  ...
                  <div className='mdma-section-left'>
                    ...
                    <br/>Several factors determine any individual’s reaction to MDMA intake, including other stimulants present in the body, your body’s metabolism, preexisting conditions, the strength of the batch, and the dosage amount.
                    </p>
                  </div>

                  <div className='mdma-section-right'>
